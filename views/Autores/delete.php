...
<body>
    <div>
        ...
        <a style="color: white;display: flex; align-items: center; justify-content: center;" href="index.php?page=Autores"><button type="button" class="btn btn-light">Volver</button></a>
    </div>
</body>
</html>
